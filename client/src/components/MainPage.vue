    ...
    <el-menu :default-openeds="['2', '3']">
      ...
      <el-submenu index="2">
        ...
        <el-menu-item-group>
          ...
          <el-menu-item index="1-3" @click="TurnToCalender">日历管理</el-menu-item>
          <el-menu-item index="1-4" >聚会管理</el-menu-item>
          <el-menu-item index="1-5" @click="TurnToImageWall">照片墙</el-menu-item>
          <el-menu-item index="1-6" @click="TurnToRoulette">随机轮盘</el-menu-item>
          <el-menu-item index="1-7" @click="TurnToUpload">Upload</el-menu-item>
        </el-menu-item-group>
      </el-submenu>
    </el-menu>
  </el-aside>
