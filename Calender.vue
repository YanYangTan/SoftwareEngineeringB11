...
export default {
  ...
  methods:
  {
    ...
    loadState() {
      ...
      datatmp.busy = 'false';
      datatmp.calendar = '';
      datatmp.color = '#148ca2';
      datatmp.description = 'Date';
      datatmp.forecolor = '#ffffff';
      datatmp.icon = 'favorite';
      datatmp.location = 'Home';
      datatmp.title = 'Date';

      scheduletmp.dayOfMonth = [15];
      scheduletmp.month = [11];
      scheduletmp.times = ['11:00'];
      scheduletmp.year = [2021];

      eventtmp.data = datatmp;
      eventtmp.schedule = scheduletmp;
      state.events.push(eventtmp);
