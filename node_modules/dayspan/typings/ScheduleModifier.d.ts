...
declare type Iter<R, T> = Iterate<R, string, ScheduleModifier<T>>;
/**
...
export declare class ScheduleModifier<T> {
     ...
     */
    iterate(): Iter<[IdentifierInput, T], T>;
    /**
     ...
     * @returns A new instance of an [[Iterator]].
     */
    query(query: IdentifierInput): Iter<[IdentifierInput, T], T>;
    /**
     * Returns all identifiers stored in this modifier.
     */
    identifiers(filter?: (value: T, id: IdentifierInput) => boolean): Iter<IdentifierInput, T>;
    /**
     ...
     */
    spans(endInclusive?: boolean): Iter<ScheduleModifierSpan<T>, T>;
    /**
