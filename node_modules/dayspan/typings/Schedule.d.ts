 ...
 */
declare type Iter<M, T = Day> = Iterate<T, number, Schedule<M>>;
/**
...
export declare class Schedule<M> {
     ...
     */
    getMaximum(prop: DayProperty): number;
    /**
     ...
     */
    getOccurrences(): Iterate<DaySpan, IdentifierInput, Schedule<M> | ScheduleModifier<M>>;
    /**
     ...
     */
    iterateIncludeTimes(day: Day, matchAgainst?: Day): Iterate<DaySpan, string, ScheduleModifier<boolean>>;
    /**
     ...
     */
    static forTime<M>(input: DayInput, time: TimeInput, duration?: number, durationUnit?: Unit): Schedule<M>;
    /**
